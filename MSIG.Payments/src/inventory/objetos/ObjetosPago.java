...
public class ObjetosPago {
    ...
    public int getNo_factura_pago() {
        return no_factura_pago;
    }

    public void setNo_factura_pago(int no_factura_pago) {
        this.no_factura_pago = no_factura_pago;
    }
