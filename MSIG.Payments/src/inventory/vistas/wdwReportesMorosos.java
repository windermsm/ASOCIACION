 ...
 */
public class wdwReportesMorosos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Clientes Morosos");
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
        ...
        try {
            ...
            URL url_reporte = this.getClass().getResource("/inventory/reportes/rptMoroso.jasper");
            JasperReport reporte = (JasperReport) JRLoader.loadObject(url_reporte);
            HashMap parametro = new HashMap();
            parametro.put("P_MES", Integer.parseInt(txtFecha.getText()));
