 ...
 */
public class wdwReportesImpresionRecibosCobro extends javax.swing.JInternalFrame {
     ...
     */
    public wdwReportesImpresionRecibosCobro() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Impresion de Recibos");
        ...
        cbxTipoReporte.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Corrrelativo", "Direccion" }));
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
        ...
        if(cbxTipoReporte.getSelectedItem().toString().equals("Correlativo")){
            nombre_reporte = "rptImpresionAvisosCorrelativo";
        } else {
            nombre_reporte = "rptImpresionAvisos";
        }
        ...
        try {
            ...
            if(txtCliente.getText().isEmpty()){
                ...
                parametro.put("P_ID_CLIENTE", Integer.parseInt(txtCliente.getText()));
            }
            parametro.put("P_ESTADO", "G");
    ...
    private javax.swing.JComboBox cbxTipoReporte;
